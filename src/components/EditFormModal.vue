                ...
                <div class="modal-body">
                    <form @submit.prevent="updatePersondata" class="row">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="fname" :value="PersonData.fname" />
                        </div>
                        <div class="col-md-6">
                            <label for="lname" class="form-label">Last Name</label>
                            <input type="text" class="form-control" id="lname" :value="PersonData.lname" />
                        </div>
                        <div class="col-md-3">
                            <label for="age" class="form-label">Age</label>
                            <input type="number" class="form-control" id="age" :value="PersonData.age" />
                        </div>
                        <div class="col-md-5">
                        ...
                        <div class="col-md-12 modal-footer mt-4">
                            ...
                            <button type="submit" class="btn btn-primary" data-bs-dismiss="modal" @click="test">
                                Save changes
                            </button>
                        </div>
                    </form>
